...
for split in ['dev', 'test', 'train']:
    ...
    with open(f'{COVOST_PATH}/covost_v2.de_en.{split}.tsv', 'r') as tsv, open(f'{COVOST_PATH}/tmp/{split_renaming[split]}.de', 'w') as txt_de, open(f'{COVOST_PATH}/tmp/{split_renaming[split]}.en', 'w') as txt_en :
