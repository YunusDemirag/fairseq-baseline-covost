fairseq-generate data-bin/covost \
    ...
    --results-path results/covost/transformer --gen-subset train
...
python format_results_for_knowledge_distillation.py --hypotheses ./results/covost/transformer/hypotheses.txt \
